  ...
  <div class="bg-white rounded-lg shadow-md p-8 w-full max-w-md">
    ...
    <form method="POST" action="{{ route('register.store') }}">
      ...
      <div class="mb-4">
        ...
        <div class="relative">
          <span class="absolute inset-y-0 left-0 flex items-center pl-2">
            <!-- Ícono de teléfono con estilo menos redondeado -->
            <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
              <path d="M6.62 10.79a15.053 15.053 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.05-.24c1.12.37 2.33.57 3.54.57a1 1 0 0 1 1 1v3.4a1 1 0 0 1-1 1C10.07 21 3 13.93 3 5.5a1 1 0 0 1 1-1h3.4a1 1 0 0 1 1 1c0 1.21.2 2.42.57 3.54a1 1 0 0 1-.24 1.05l-2.11 2.2z"/>
            </svg>
          </span>
          <input 
            id="telefono" 
      ...
      <button 
        type="submit" 
        class="w-full bg-gradient-to-r from-indigo-500 to-purple-700 text-white text-white font-semibold py-2 rounded transition-colors"
      >
        Crear cuenta
      </button>
      ...
      <p class="text-xs text-gray-500 mt-3">
        ...
        <a href="{{ route('terminos') }}" class="text-purple-600 hover:underline">Términos de Servicio</a> 
        y la 
        <a href="{{ route('privacidad') }}" class="text-purple-600 hover:underline">Política de Privacidad</a>.
      </p>
