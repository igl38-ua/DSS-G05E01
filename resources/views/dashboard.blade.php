...
<div class="flex min-h-screen bg-gray-100">
  ...
  <aside class="w-64 bg-white shadow-lg hidden lg:flex flex-col">
    ...
    <nav class="flex-1 p-4 space-y-3">
      <a href="{{ route('clases') }}" class="flex items-center px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700">
        <i class="fas fa-dumbbell mr-3 text-purple-400"></i>
        <span>Clases</span>
      </a>
      <a href="{{ route('suscripciones') }}" class="flex items-center px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700">
  ...
  <main class="flex-1 p-8">
    ...
    <div class="flex justify-between items-center mb-8">
      ...
      <div class="flex items-center space-x-4">
        <button class="btn-primary">Actualiza tu suscripción</button>
