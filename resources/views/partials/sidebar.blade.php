<aside class="w-64 bg-white shadow-lg hidden lg:flex flex-col">
  ...
  <nav class="flex-1 p-4 space-y-3">
    <a href="{{ route('dashboard') }}"
       class="flex items-center px-4 py-2 bg-gray-200 text-gray-900 rounded-lg hover:bg-gray-200">
    ...
    <a href="{{ route('mis-clases') }}"
       class="flex items-center px-4 py-2 bg-gray-200 text-gray-900 rounded-lg hover:bg-gray-200">
      <i class="fas fa-dumbbell mr-3 text-indigo-500"></i>
      <span>Clases</span>
    </a>

    <a href="{{ route('mi-suscripcion') }}"
       class="flex items-center px-4 py-2 bg-gray-200 text-gray-900 rounded-lg hover:bg-gray-200">
      <i class="fas fa-credit-card mr-3 text-indigo-500"></i>
      <span>Suscripción</span>
    </a>

    <!-- <a href="{{ route('progreso') }}" ...> ... </a> -->
    ...
    <form method="POST" action="{{ route('logout') }}">
      @csrf
      <button type="submit"
              class="w-full flex items-center px-4 py-2 bg-gray-200 text-gray-900 rounded-lg hover:bg-gray-200">
