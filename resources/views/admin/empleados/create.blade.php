...
<div class="max-w-3xl mx-auto my-10 px-4">
    ...
    <!-- Formulario -->
    <form action="{{ route('empleados.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" name="horarioTrabajo" value="{{ old('horarioTrabajo') }}"
                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nomina" value="{{ old('nomina') }}"
                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
